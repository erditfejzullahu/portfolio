...
const SideProjects = () => {
  ...
  return (
    <>
      <div style={{transform: transformStyle}} ref={top} className="absolute z-[90] left-4 top-0 bottom-0 max-h-[40%] overflow-y-scroll my-auto rounded-xl shadow-lg shadow-gray-500 p-3 bg-white flex flex-col gap-4 items-center">
        {projects.map((item) => (
