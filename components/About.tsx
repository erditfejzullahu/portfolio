...
const About = () => {
  ...
  return (
    <div className="relative my-20 max-md:my-10 w-screen before:hidden container mx-auto px-4 " id='about'>
      ...
      <div className="mt-10 max-md:mt-5 p-4 relative z-10 shadow-lg shadow-[rgba(0,0,0,0.15)]  custom-shape">
